...
const Prueba = (): JSX.Element => {
  ...
  return (
    <>
      ...
      <div className="absolute top-0 left-0 flex flex-col items-center justify-center w-full bg-red-500">
        <span>
        ...
        <div className="flex flex-col p-4">
          ...
          <span>
            - Anchura:
            {deviceScreenViewportTotal ? deviceScreenViewportTotal.width : 'unknown'}
            px
          </span>
          <span>
            - Altura:
            {deviceScreenViewportTotal ? deviceScreenViewportTotal.height : 'unknown'}
            px
          </span>
        </div>
        <div className="flex flex-col p-4">
          ...
          <span>
            - Anchura:
            {webBrowserViewportTotal ? webBrowserViewportTotal.width : 'unknown'}
            px
          </span>
          <span>
            - Altura:
            {webBrowserViewportTotal ? webBrowserViewportTotal.height : 'unknown'}
            px
          </span>
        </div>
        <div className="flex flex-col p-4">
          ...
          <span>
            - Anchura:
            {webBrowserViewport ? webBrowserViewport.width : 'unknown'} px
          </span>
          <span>
            - Altura:
            {webBrowserViewport ? webBrowserViewport.height : 'unknown'} px
          </span>
        </div>
